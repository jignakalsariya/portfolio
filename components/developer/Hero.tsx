...
export default function Hero() {
  return (
    <section className="bg-black w-full flex flex-col overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 pt-10 sm:pt-14 md:pt-16 lg:pt-20 pb-10 md:pb-16 flex flex-col md:flex-row items-center gap-10 lg:gap-16">
